...
corrplot(cor(X), col=col(100),  diag=FALSE, cl.pos = 'b', tl.pos = 'd', tl.col = 'black', addCoef.col = 'black')
...
corrplot(C, col="black", type = "upper", method="number", diag=FALSE)
